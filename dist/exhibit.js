...
let focus=null,formCameraTimer=0;function home(){controls.enableDamping=true;document.body.classList.remove('inspecting');$('inspection').hidden=true;focus={position:new THREE.Vector3(state.target?4:4,state.target?2.5:2.9,state.explode?10:state.target?6.5:7.6),target:new THREE.Vector3(0,state.target?.7:1.72,0)};}
