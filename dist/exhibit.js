...
const reflection=new Reflector(new THREE.PlaneGeometry(6.8,6.8),{clipBias:.004,textureWidth:512,textureHeight:512,color:new THREE.Color('#12191f')});reflection.rotation.x=-Math.PI/2;reflection.position.y=-.003;reflection.material.uniforms.color.value.set('#12191f');scene.add(reflection);
