...
const reflection=new Reflector(new THREE.PlaneGeometry(18,18),{clipBias:.003,textureWidth:1024,textureHeight:1024,color:0x11151b});reflection.rotation.x=-Math.PI/2;reflection.position.y=-.004;reflection.material.transparent=true;reflection.material.opacity=.16;scene.add(reflection);
