...
const floor=new THREE.Mesh(new THREE.PlaneGeometry(100,100),new THREE.MeshPhysicalMaterial({color:'#080a0d',roughness:.28,metalness:.72,clearcoat:.32,clearcoatRoughness:.2,envMapIntensity:.8}));floor.rotation.x=-Math.PI/2;floor.position.y=-.007;floor.receiveShadow=true;scene.add(floor);
