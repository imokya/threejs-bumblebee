...
function form(target){state.target=target;state.explode=0;document.body.classList.remove('inspecting');$('inspection').hidden=true;clearTimeout(formCameraTimer);if(target===1){focus=null;formCameraTimer=setTimeout(home,700);}else home();}
